...
export default function AqiqahBanyumasPage() {
  const jsonLd = {
    ...
    "@graph": [
      {
        "@type": "LocalBusiness",
        "@id": "https://www.jasaqiqah.my.id/aqiqah-banyumas/#organization",
        "name": "Farhan Aqiqah Banyumas",
        "description": "Jasa Aqiqah terbaik di wilayah Kabupaten Banyumas. Masakan lezat sesuai syariat.",
        "url": "https://www.jasaqiqah.my.id/aqiqah-banyumas",
      ...
      <main className="w-full bg-white overflow-hidden">
        ...
        <section className="pt-32 pb-20 bg-[#fdfaf0] border-b border-accent/10 text-center">
          <div className="max-w-5xl mx-auto px-6">
            <p className="text-accent font-black text-xs md:text-sm uppercase tracking-[0.3em] mb-4">Layanan Spesialis Banyumas</p>
        ...
        <article className="py-24 max-w-4xl mx-auto px-6 prose prose-headings:text-primary prose-headings:font-black prose-p:text-gray-600 prose-p:leading-relaxed prose-strong:text-primary">
          <h2 id="utama">Mengapa Farhan Aqiqah Menjadi Pilihan Utama di Banyumas?</h2>
          <p>
            Menjalankan ibadah aqiqah adalah momen sakral bagi setiap orang tua di Banyumas. Sebagai bentuk syukur atas kelahiran putra atau putri tercinta, pemilihan <strong>jasa aqiqah Banyumas</strong> tidak boleh dilakukan sembarangan. Anda memerlukan mitra yang memahami tata cara syariat sekaligus mampu menyajikan hidangan berkualitas tinggi untuk para tamu dan kerabat.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 not-prose my-12">
            {[
              ...
              <div key={i} className="p-6 bg-gray-50 rounded-3xl border border-gray-100 text-center transition-all hover:border-accent/20">
          ...
          <ul>
            ...
            <li><strong>Tengkleng:</strong> Olahan tulang dan daging dengan kuah rempah yang segar, gurih, dan menggugah selera.</li>
            <li><strong>Bistik Kambing:</strong> Pilihan menu modern dengan saus bistik yang kental untuk variasi hidangan aqiqah Anda.</li>
          </ul>
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-start mb-16">
              <div className="space-y-6">
                ...
                <div className="bg-black/40 border border-accent/20 rounded-3xl p-4 flex items-center gap-4">
                  <div className="w-10 h-10 bg-accent rounded-xl flex items-center justify-center text-[#0f0e0a] shrink-0"><Star size={20} fill="currentColor" /></div>
                  <div className="flex-1"><h4 className="text-white font-black text-xs uppercase tracking-wider">Bonus Banyumas</h4>
              ...
              <div className="bg-white/[0.03] backdrop-blur-2xl rounded-[2.5rem] p-8 border border-white/10 flex flex-col gap-6 h-full justify-center">
                <div>
                  <p className="text-accent font-black text-[10px] uppercase tracking-[0.5em] mb-1">Harga Nasi Box</p>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {["Nasi", "Kari Kentang", "Capcay", "Acar", "Kerupuk", "Alat Makan"].map((m, i) => (
                    <div key={i} className="flex items-center gap-2 bg-white/[0.05] p-2.5 rounded-xl border border-white/5">
                ...
                <div className="space-y-3 pt-4 border-t border-white/10">
                  <div className="bg-black border border-accent/30 text-white p-4 rounded-2xl flex justify-between items-center transition-all hover:border-accent">
        ...
        <section className="py-24 bg-accent text-center relative overflow-hidden">
          <div className="max-w-4xl mx-auto px-6 relative z-10">
            <h2 className="text-4xl md:text-5xl font-black text-primary mb-6 uppercase tracking-tighter">Aqiqah di Banyumas Jadi Lebih Mudah</h2>
            <p className="text-primary/70 font-medium mb-10 max-w-xl mx-auto">Hubungi admin Farhan Aqiqah sekarang untuk mendapatkan penawaran harga terbaik dan konsultasi syariat gratis.</p>
