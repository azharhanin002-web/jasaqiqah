  ...
  return (
    <div className="mt-16 mb-10 p-8 md:p-10 bg-[#fff9f0] border border-[#fef3c7] rounded-[2.5rem] flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm overflow-hidden">
      <div className="text-center md:text-left flex-1 min-w-0">
        {/* JUDUL: Ukuran dikecilkan sedikit (28px) & dipaksa satu baris */}
        ...
        {/* DESKRIPSI: Ukuran dikecilkan (15px) agar tidak mendorong tombol keluar */}
      ...
      {/* TOMBOL: Ukuran lebih compact (padding & font dikecilkan) */}
